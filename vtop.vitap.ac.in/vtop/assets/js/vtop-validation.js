    ...
    name: {
      ...
      validators: {
        ...
        stringLength: {
          ...
          max: 11,
          message:
            "The name must be more than 3 and less than 50 characters long",
        },
        /*remote: {
	                        url: 'remote',
    ...
    passwd: {
      validators: {
        ...
        stringLength: {
          ...
          max: 30,
          message:
            "The password must be minimum 8 and maximum 30 characters long",
        },
      },
    },
    choice: {
    ...
    mobile: {
      ...
      validators: {
        ...
        regexp: {
          regexp: /^[789]\d{9}$/,
          message:
            "The mobile number is exactly 10 digits and starts with only 7/8/9",
        },
      },
    },
    ...
    intercom: {
      ...
      validators: {
        ...
        regexp: {
          regexp: /^[2]\d{3}$/,
          message:
            "The intercom number is exactly 4 digits and starts with only 2 in VIT",
        },
      },
    },
    ...
    regno: {
      validators: {
        ...
        regexp: {
          ...
          message:
            "The regno starts with number, must be more than 8 and less than 10 characters long",
        },
      },
    },
    newPwd: {
      validators: {
        ...
        stringLength: {
          ...
          max: 30,
          message:
            "The password must be more than 9 and less than 30 characters long",
        },
      },
    },
    cnfrmNewPwd: {
      validators: {
        ...
        stringLength: {
          ...
          max: 30,
          message:
            "The confirm password must be more than 9 and less than 30 characters long",
        },
      },
    },
    otpMobile: {
